    ...
    public class ApuestaRepository
    {
        ...
        internal List<ApuestaDTO> RetrieveDTO()
        {
            ...
            using (PMBContext context = new PMBContext())
            {
                ...
                List<ApuestaDTO> mercados = context.Apuestas.Select(p => ToDTO(p)).ToList();
                return mercados;
        ...
        {
            return new ApuestaDTO(e.TipoApuesta, e.Dinero, e.UsuarioId,e.EventoId);
        }


        internal Apuesta Put(int id)
        {
            Apuesta apuesta;
